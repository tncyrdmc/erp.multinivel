													...
													<div class="row">
																	...
																	<div class="col-sm-12">
																		<div id="myCarousel" class="carousel fade profile-carousel">
																			<div class="air air-top-left padding-10">
																				<h4 class="txt-color-white font-md">Felicitacitamos a </h4>
																			</div>
																			...
																			<div class="carousel-inner">
																				...
																				<div class="item active">
																					<img src="/template/img/demo/s1.jpg" alt="demo user">
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-sm-12">
																		...
																		<div class="row">
																			...
																			<div class="col-sm-3 profile-pic">
																				<img src="/template/img/empresario.jpg" alt="demo user">
																			...
																			<div class="col-sm-6">
																				...
																				<ul class="list-unstyled">
																					<li>
																						<p class="text-muted">
																							<i class="fa fa-phone"></i>&nbsp;&nbsp;(<span class="txt-color-darken">044</span>) <span class="txt-color-darken">55</span> - <span class="txt-color-darken">29529842</span>
																						</p>
																					</li>
																				</ul>
																...
																<div class="row">
																	...
																	<div class="col-sm-12">
																		...
																		<div class="row">
																			...
																			<div class="col-sm-6">
																				<h1><span class="semi-bold">Andres Velez</span>
																				<br>
																				<small>Diamante</small></h1>
														...
														<div class="col-sm-12 col-md-12 col-lg-6">
															<div class="well well-light well-sm no-margin no-padding">
																<div class="row">
																	<div class="col-sm-12">
																		<div id="myCarousel1" class="carousel fade profile-carousel">
																			<div class="air air-top-left padding-10">
																				<h4 class="txt-color-white font-md">Felicitacitamos a </h4>
																			</div>
																			<ol class="carousel-indicators">
																			...
																			<div class="carousel-inner">
																				...
																				<!-- Slide 2 -->
																				<div class="item active">
																					<img src="/template/img/demo/s2.jpg" alt="demo user">
																				</div>
																				<!-- Slide 3 -->
																				<div class="item">
																	...
																	<div class="col-sm-12">
																		...
																		<div class="row">
																			...
																			<div class="col-sm-3 profile-pic">
																				<img src="/template/img/avatars/sunny-big.png" alt="demo user">
																				<div class="padding-10">
																				</div>
																			</div>
																			<div class="col-sm-6">
