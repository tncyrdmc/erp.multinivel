...
<?php
$telefono_movil = explode("/", $contactos[1]->telefono_movil);
...
<?php } ?>
<?php
$telefono_movil = explode("/", $contactos[1]->telefono_fijo);
foreach ($telefono_movil as $telefono) {
    ?>
                <div class="col col-xs-12 col-sm-6 col-lg-6">
        ...
        <div class="row">
            ...
            foreach ($telefono_movil as $telefono) {
                ...
                <div class="col col-xs-12 col-sm-6 col-lg-6">
                    Teléfono Movil<label for="" class="input">
                        <i class="icon-prepend fa fa-phone"></i>
                        <input name="telefonomovil2[]" placeholder="Teléfono Movil" data-mask="999 999-9999" type="tel" pattern="[0-9]{7,50}" value="<?php echo $telefono; ?>">
                    </label>
                </div>
            <?php } ?>
            <?php
            ...
            foreach ($telefono_movil as $telefono) {
                ...
                <div class="col col-xs-12 col-sm-6 col-lg-6">
                    Teléfono Fijo<label for="" class="input">
                        <i class="icon-prepend fa fa-phone"></i>
                        <input name="telefonofijo2[]" placeholder="Teléfono Fijo" data-mask=" (999) 999-9999" type="tel" pattern="[0-9]{7,50}" value="<?php echo $telefono; ?>">
                    </label>
                </div>
<?php } ?>
