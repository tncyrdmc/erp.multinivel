	...
	<div class="row">
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			...
			<h1 class="page-title txt-color-blueDark">
				...
				<span> > <a href="/bo/logistico2/alta"> Alta </a> > <a
					href="/bo/logistico2/movimiento"> Movimiento al Inventario</a> >
					Listar
				</span>
			</h1>
		</div>
				 <?php }else{?>
					<a class="backHome" href="/bo"><i class="fa fa-home"></i> Menu</a>
		<span>> <a href="/bol/dashboard/"> Logístico </a> > <a
			href="/bo/logistico2/alta"> Alta </a> > <a
			href="/bo/logistico2/movimiento">Movimiento al Inventario</a> >
			Listar
		</span>
					...
					<div class="tab-pane">
						...
						<table id="dt_basic"
							...
							<tbody>
									...
									<td class='text-center'><a class='txt-color-red'
...
function estado(estatus, id)
{
	...
	bootbox.dialog({
		...
		buttons: {
			...
			callback: function() {
				...
				$.ajax({
					type: "POST",
					url: "/bo/inventario/estadoMovimiento",
					data: {
						id:id, 
						estado: estatus
					},
	...
	function editar(id){
		$.ajax({
			type: "POST",
			url: "/bo/inventario/editarMovimiento",
			data: {
				id: id
				}
		...
		.done(function( msg )
		{
			...
			buttons: {
				...
				callback: function() {
						...
						$.ajax({
							type: "POST",
							url: "/bo/inventario/killMovimiento",
							data: {id: id}
						}).done(function( msg )
						{
