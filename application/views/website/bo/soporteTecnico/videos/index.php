				...
				<div class="row">
					<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
						<h1 class="page-title txt-color-blueDark">
							...
							<span>>
								<a href="/bo/configuracion/videos_ver_redes">Ver Redes</a> > Videos
							</span>
						</h1>
					</div>
				</div>
                  ...
                  <div class="contenidoBotones">
										<div class="row">
											...
											<div class="col-sm-6 link">
												...
												<a href="/bo/configuracion/alta_videos?id_red=<?php echo $id_red;?>">
												...
												<div class="col-sm-4 link">
												<a href="/bo/configuracion/listar_videos?id_red=<?php echo $id_red;?>">
