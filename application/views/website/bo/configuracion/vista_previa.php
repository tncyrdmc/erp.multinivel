				...
				<div class="content">
					<table>
						<tr>
							...
							<td align="right"><h6 class="collapse">BANNER</h6></td>
						</tr>
					</table>
				</div>
	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3><?=$img ? $img[0]->titulo : "asunto"?></h3>
						<?php echo $img ? '<p class="lead">'.$img[0]->descripcion.'</p>' : '<p class="lead">sumario</p>'?>
						<div class="col-md-12"><?=$img ? "<img src=\"/media/Empresa/".$img[0]->nombre_banner."\" alt=\"\" width=\"100%\"/> " : "contenido"?></div>
						<br /><br />				
	...
	<tr>
		...
		<td class="container" >
				...
				<tr>
					<td align="center">
						<p>
							<a style="color: white; text-decoration: none;" href="">Visita nuestra página web</a>
						</p>
					</td>
				</tr>
			</table>
