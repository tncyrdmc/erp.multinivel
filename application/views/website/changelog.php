...
<html lang="en-us" id="extr-page">
	...
	<!-- row -->
				<div class="row">
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><h3><a href="/auth">Regresar</a></h3></div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="smart-timeline">
								<ul class="smart-timeline-list">
									...
									<li>
										...
										<div class="smart-timeline-content">
											<p>
												<a href="javascript:void(0);"><strong>Adición del plugin jqueryte wyswyg</strong></a>
											</p>
										</div>
