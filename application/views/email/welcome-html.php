...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#1B7AEF">
	<tr>
		<td></td>
		<td class="header container">
			
				<div class="content">
					<table bgcolor="#1B7AEF">
					<tr>
						<td align="left"><img style="max-width: 90px;" src="<?=site_url('/logo.png')?>" alt="Logo"/></td>
						<td align="right"><h6 class="collapse">Bienvenid@</h6></td>
					</tr>
				</table>
				</div>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p>Teléfono: <strong>00 00 00 00</strong><br/>
                							Email: <strong><a href="contacto@networksoft.mx">contacto@networksoft.mx</a></strong></p>
