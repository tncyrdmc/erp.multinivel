	...
	<div class="row">
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			<h1 class="page-title txt-color-blueDark">
				...
				<span>>
				<a href="/bo/oficinaVirtual/"> Oficina Virtual</a> > <a href="/bo/oficinaVirtual/descargas">Descargas</a>
				> Alta </span> 
			</h1>
		</div>
	</div>
									...
									<div class="row">
										<div class="col col-xs-12 col-sm-9 col-md-9 col-lg-9">
											<div class="widget-body">
												<form class="smart-form" id="reporte-form" method="post" action="CrearArchivo" enctype="multipart/form-data">
													<div class="row">
														<section
