			...
			<article class="col-sm-12 col-md-6 col-lg-6">
				...
				<div class="jarviswidget" id="wid-id-20" data-widget-editbutton="false" data-widget-custombutton="false">
					...
					<div>
						...
						<div class="widget-body">
							<h5>En tu red existen</h5><hr>
							<div id="donut-graph1" class="chart no-padding"></div>
						</div>
						<!-- end widget content -->
			...
			<article class="col-sm-12 col-md-6 col-lg-6">
				...
				<div class="jarviswidget" id="wid-id-30" data-widget-editbutton="false" data-widget-custombutton="false">
					...
					<div>
						...
						<div class="widget-body">
							<h5>En tu red existen</h5><hr>
							<div id="bar-graph1" class="chart no-padding"></div>
						</div>
						<!-- end widget content -->
			...
			<article class="col-sm-12 col-md-6 col-lg-6">
				...
				<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
					...
					<div>
						...
						<div class="widget-body">
							<h5>En tu red existen</h5><hr>
							<div id="donut-graph2" class="chart no-padding"></div>
						</div>
						<!-- end widget content -->
...
//////////////////////	esto no va	//////////////////////
	...
	if ($('#sales-graph1').length) {
		Morris.Area({
			element : 'sales-graph1',
			data : [
				{
					period : '2014-06-01',
					dinerillo : 500,
