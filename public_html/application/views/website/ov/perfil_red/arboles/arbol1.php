												...
												<a style="background: url('<?=$img_perfil?>'); background-size: cover; background-position: center;" href="#"><div
													...
													<ul>
																		...
																		foreach ( $afiliadostree as $key ) {
																			...
																			if ($key->debajo_de == $id) {
																				?>
																			<li id="t<?=$key->id_afiliado?>"><a class="quitar" style="background: url('<?=$img?>'); background-size: cover; background-position: center;" onclick="subtree(<?=$key->id_afiliado?>)" href="#"></a>
