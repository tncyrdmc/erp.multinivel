...
$extensions = array('mobileapp','mobilewebapp','jabber');
...
$crplugins = array('chattime','style','filetransfer','smilies','avchat','broadcast','screenshare','transliterate','whiteboard','writeboard');
