...
class CI_Email {
	...
	var	$smtp_host		= "ssl://smtp.mandrillapp.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "gianci15@ingenieros.com";		// SMTP Username
	var	$smtp_pass		= "58A12xSnBC6qcghwCHwetw";		// SMTP Password
