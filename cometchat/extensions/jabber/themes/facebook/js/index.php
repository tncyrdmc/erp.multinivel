            ...
            getRecentDataAjaxSuccess:  function(data , id , originalid) {
                $.each(data, function(id, message) {
                    ...
                    if(message.type == 'sent'){
						...
						selfstyleAvatar = '<a class="floatL" href="'+jqcc.cometchat.getThemeArray('buddylistLink',jqcc.cometchat.getThemeVariable("userid"))+'"><img src="'+jqcc.cometchat.getThemeArray('buddylistAvatar', jqcc.cometchat.getThemeVariable("userid"))+'" title="'+fromname+'"/></a>';
					}
                    var sentdata = '';
                    ...
                    if(message.type == 'sent') {
                        $('#cometchat_tabcontenttext_'+originalid).append('<div class="cometchat_chatboxmessage" id="cometchat_message_'+message.time+'"><div class="cometchat_chatboxmessagecontent cometchat_self floatR" title="'+sentdata+'">'+message.msg+'</div><div class="selfMsgArrow"></div></div>');
                    } else {
                        $('#cometchat_tabcontenttext_'+originalid).append('<div class="cometchat_chatboxmessage" id="cometchat_message_'+message.time+'">'+selfstyleAvatar+'<div class="cometchat_chatboxmessagecontent floatL" title="'+sentdata+'">'+message.msg+'</div><div class="msgArrow"></div></div>');
                    }
