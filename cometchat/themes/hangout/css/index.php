...
.cometchat_maxwindow {
	background: url(themes/<?php echo $theme;?>/images/cometchat.png) no-repeat top left;
	background-position: -2px  -1177px;
	float: <?php echo $right;?>;
	height: 15px;
	width: 15px;
	cursor: pointer;
...
#cometchat_chatboxes .cometchat_tabclick{
    background-color: <?php echo $themeSettings['tab_title_background'];?> !important;
}
.cometchat_tabclick {
	background-color: <?php echo $themeSettings['tab_background'];?> !important;
...
.cometchat_userstabtitle_available {
        border-bottom: 2px solid #53A93F;
}

.cometchat_userstabtitle_away {
        border-bottom: 2px solid #FF9C36;
}

.cometchat_userstabtitle_busy {
        border-bottom: 2px solid #EF2A3E;
}

.cometchat_userstabtitle_invisible {
...
.cometchat_tabcontenttext {
	...
	border-bottom: 1px solid <?php echo $themeSettings['tab_border_light'];?>;
	height: <?php echo ($chatboxHeight-1).'px';?>;
	overflow-x: hidden;
	overflow-y: auto;
	padding: 5px;
...
.cometchat_textarea {
	...
	padding: 0px;
	resize: none;	
        width: <?php echo($chatboxWidth-31-24).'px';?>;    
        padding-top: 2px;
...
.cometchat_other:before {
        border-color: rgba(0, 0, 0, 0) <?php echo $themeSettings['tab_background'];?> rgba(0, 0, 0, 0) rgba(0, 0, 0, 0);
        border-style: solid;
...
.cometchat_other_noarrow:before {
        border-style: none !important;
}

.cometchat_self_content .cometchat_ts {
        float:left;
}
...
.cometchat_self_content:after {
        border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) <?php echo $themeSettings['tab_background'];?>;
        border-style: solid;
...
.cometchat_chatboxmessagefrom a > img {
        ...
        -moz-box-shadow:    0 0 1px #FFFFFF !important;
        -webkit-box-shadow: 0 0 1px #FFFFFF !important;
        box-shadow:         0 0 1px #FFFFFF !important;
}

.cometchat_self_avatar a > img {
        border-radius: 0 3px 3px 0 !important;
}

.cometchat_self_content {
        -moz-box-shadow:    -1px 1px 2px 0 #BBBBBB !important;
        -webkit-box-shadow: -1px 1px 2px 0 #BBBBBB !important;
        box-shadow:         -1px 1px 2px 0 #BBBBBB !important;
}
...
.cometchat_chatboxmessagecontent {
        ...
        width: 80%;
        margin-bottom: 6px;
        -moz-box-shadow:    1px 1px 2px 0 #BBBBBB;
        -webkit-box-shadow: 1px 1px 2px 0 #BBBBBB;
...
.cometchat_tabsubtitle2 {
	...
	background-color: <?php echo $themeSettings['tab_sub_background'];?>;
	<?php if($lang == 'en'):?>
	background: url(extensions/jabber/jabber_dark.png) no-repeat 5px 5px;
	<?php endif;?>	
	border-bottom: 1px solid <?php echo $themeSettings['tab_border_light'];?>;
	border-left: 1px solid <?php echo $themeSettings['tab_border'];?>;
	border-right: 1px solid <?php echo $themeSettings['tab_border'];?>;
...
.cometchat_tabtitle_available {
        border-bottom: 2px solid #53A93F;
}

.cometchat_tabtitle_away {
        border-bottom: 2px solid #FF9C36;
}

.cometchat_tabtitle_busy {
        border-bottom: 2px solid #EF2A3E;
}

.cometchat_tabtitle_offline {
        border-bottom: 2px solid #A9A9A9;
}

.cometchat_buddy_available {
        border-bottom: 2px solid #53A93F;
}

.cometchat_buddy_away {
        border-bottom: 2px solid #FF9C36;
        padding-bottom: 2px;
}

.cometchat_buddy_busy {
        border-bottom: 2px solid #EF2A3E;
        padding-bottom: 2px;
}

.cometchat_buddy_offline {
        border-bottom: 2px solid #A9A9A9;
        padding-bottom: 2px;
}
...
.cometchat_new_message {
        background: <?php echo $themeSettings['tab_link_color'];?> !important;
        border-color: <?php echo $themeSettings['tab_link_color'];?> !important;
}
...
.cometchat_clearconversation{ background-position: 0 -330px; width: 12px; height: 16px; } 
